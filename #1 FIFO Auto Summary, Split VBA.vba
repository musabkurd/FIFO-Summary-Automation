...
Private Sub CreateRSMWorkbook(wbSource As Workbook, rsmFolder As String, rsmName As String, stamp As String)
    ...
    GenerateTopDistributorsFromFiltered wbNew.Sheets(4), wbNew.Sheets(5), rsmName
...
Private Sub GenerateTopDistributorsFromFiltered(wsOut As Worksheet, wsExpired As Worksheet, rsmName As String)
