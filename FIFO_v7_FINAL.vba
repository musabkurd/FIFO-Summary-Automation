...
Private Sub CreateRSMWorkbook(wbSource As Workbook, rsmFolder As String, rsmName As String, stamp As String)
    ...
    ' Current order after blank delete: ملخص عام(1), أعلى 10 منتجات(2), أعلى وکلاء(3), بقی شهر(4), منتهية الصلاحية(5), بقی شهرین(6), بقی ٣ أشهر(7), کامل(8)
    ' Desired order: ملخص عام(1), أعلى 10 منتجات(2), أعلى وکلاء(3), منتهية الصلاحية(4), بقی شهر(5), بقی شهرین(6), بقی ٣ أشهر(7), کامل(8)
    On Error Resume Next
    ' Move منتهية الصلاحية (currently at 5) to position 4 (after أعلى وکلاء)
    wbNew.Sheets(5).Move After:=wbNew.Sheets(3)
    On Error GoTo 0
