...
Private Sub CreateProductAnalysis(ws As Worksheet, wsExp As Worksheet, ws1M As Worksheet, ws2M As Worksheet, ws3M As Worksheet)
    ...
    ws.Cells(3, 5).Value = ChrW(&H627) & ChrW(&H644) & ChrW(&H642) & ChrW(&H64A) & ChrW(&H645) & ChrW(&H629) ' Value
    ws.Range("D3:E3").Interior.Color = RGB(255, 102, 102)

    ' 1 Month (Light Red)
    ws.Cells(3, 6).Value = ChrW(&H628) & ChrW(&H642) & ChrW(&H6CC) & " " & ChrW(&H634) & ChrW(&H647) & ChrW(&H631)
    ws.Cells(3, 7).Value = ChrW(&H627) & ChrW(&H644) & ChrW(&H642) & ChrW(&H64A) & ChrW(&H645) & ChrW(&H629)
    ws.Range("F3:G3").Interior.Color = RGB(255, 153, 153)

    ' 2 Months (Orange)
    ws.Cells(3, 8).Value = ChrW(&H628) & ChrW(&H642) & ChrW(&H6CC) & " " & ChrW(&H634) & ChrW(&H647) & ChrW(&H631) & ChrW(&H6CC) & ChrW(&H646)
    ws.Cells(3, 9).Value = ChrW(&H627) & ChrW(&H644) & ChrW(&H642) & ChrW(&H64A) & ChrW(&H645) & ChrW(&H629)
    ws.Range("H3:I3").Interior.Color = RGB(255, 192, 128)

    ' 3 Months (Yellow)
    ws.Cells(3, 10).Value = ChrW(&H628) & ChrW(&H642) & ChrW(&H6CC) & " " & ChrW(&H663) & " " & ChrW(&H623) & ChrW(&H634) & ChrW(&H647) & ChrW(&H631)
    ws.Cells(3, 11).Value = ChrW(&H627) & ChrW(&H644) & ChrW(&H642) & ChrW(&H64A) & ChrW(&H645) & ChrW(&H629)
    ws.Range("J3:K3").Interior.Color = RGB(255, 230, 153)

    ' Total (Green)
    ws.Cells(3, 12).Value = ChrW(&H627) & ChrW(&H644) & ChrW(&H625) & ChrW(&H62C) & ChrW(&H645) & ChrW(&H627) & ChrW(&H644) & ChrW(&H64A)
    ws.Cells(3, 13).Value = ChrW(&H625) & ChrW(&H62C) & ChrW(&H645) & ChrW(&H627) & ChrW(&H644) & ChrW(&H64A) & " " & ChrW(&H627) & ChrW(&H644) & ChrW(&H642) & ChrW(&H64A) & ChrW(&H645) & ChrW(&H629)
...
Private Sub GenerateTop10ProductsFromFiltered(wsOut As Worksheet, ws1 As Worksheet, ws2 As Worksheet, ws3 As Worksheet, ws4 As Worksheet)
    ...
    wsOut.Cells(3, 5).Value = ChrW(&H627) & ChrW(&H644) & ChrW(&H642) & ChrW(&H64A) & ChrW(&H645) & ChrW(&H629)
    wsOut.Range("D3:E3").Interior.Color = RGB(255, 102, 102)

    ' 1 Month (Light Red)
    wsOut.Cells(3, 6).Value = ChrW(&H628) & ChrW(&H642) & ChrW(&H6CC) & " " & ChrW(&H634) & ChrW(&H647) & ChrW(&H631)
    wsOut.Cells(3, 7).Value = ChrW(&H627) & ChrW(&H644) & ChrW(&H642) & ChrW(&H64A) & ChrW(&H645) & ChrW(&H629)
    wsOut.Range("F3:G3").Interior.Color = RGB(255, 153, 153)

    ' 2 Months (Orange)
    wsOut.Cells(3, 8).Value = ChrW(&H628) & ChrW(&H642) & ChrW(&H6CC) & " " & ChrW(&H634) & ChrW(&H647) & ChrW(&H631) & ChrW(&H6CC) & ChrW(&H646)
    wsOut.Cells(3, 9).Value = ChrW(&H627) & ChrW(&H644) & ChrW(&H642) & ChrW(&H64A) & ChrW(&H645) & ChrW(&H629)
    wsOut.Range("H3:I3").Interior.Color = RGB(255, 192, 128)

    ' 3 Months (Yellow)
    wsOut.Cells(3, 10).Value = ChrW(&H628) & ChrW(&H642) & ChrW(&H6CC) & " " & ChrW(&H663) & " " & ChrW(&H623) & ChrW(&H634) & ChrW(&H647) & ChrW(&H631)
    wsOut.Cells(3, 11).Value = ChrW(&H627) & ChrW(&H644) & ChrW(&H642) & ChrW(&H64A) & ChrW(&H645) & ChrW(&H629)
    wsOut.Range("J3:K3").Interior.Color = RGB(255, 230, 153)

    ' Total (Green)
    wsOut.Cells(3, 12).Value = ChrW(&H627) & ChrW(&H644) & ChrW(&H625) & ChrW(&H62C) & ChrW(&H645) & ChrW(&H627) & ChrW(&H644) & ChrW(&H64A)
    wsOut.Cells(3, 13).Value = ChrW(&H625) & ChrW(&H62C) & ChrW(&H645) & ChrW(&H627) & ChrW(&H644) & ChrW(&H64A) & " " & ChrW(&H627) & ChrW(&H644) & ChrW(&H642) & ChrW(&H64A) & ChrW(&H645) & ChrW(&H629)
